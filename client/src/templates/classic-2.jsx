...
export function Classic2({ resume }) {
  return (
    <article className="resume-page rs-classic-2" data-template="classic-2">
          ...
          <div className="entry" key={`${item.company}-${item.role}-${index}`}>
            <div className="entry-head">
              <p className="entry-title">
                ...
                {hasText(item.location) && <span className="org"> — {item.location.trim()}</span>}
              </p>
